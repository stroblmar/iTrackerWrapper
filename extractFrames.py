...
# NOTE: For this script I modified the read function in skvideo to invert height and width. If didn't do that the videos from my phone wouldn't be processed correctly. THis might differ from phone to phone though. If your frames look like garbage, comment out the read function in this script and try the original one from skvideo.
# =============================================================
# Configure Script
...
#  =============================================================
videoList = [fName for fName in os.listdir(dataPath) if ".mp4" in fName]
...
for videoNameStr in videoList:
    ...
    # Generate folder to hold frames
    try:
        os.mkdir(outputPath)
    except:
        pass
    ...
    # Extract frames
    nFrames = 0
    # success, frame = read(vidcap) # See note about read function above
